...
uint8_t broadcastAddress1[] = {0x4C, 0x11, 0xAE, 0xEA, 0xEE, 0xB4};
...
void PairWithDevice(uint8_t Address[])
{
  // Init ESP-NOW
  ...
  switch(type) 
  {
    ...
    case WS_EVT_DATA:
    {
      ...
      { 
        ...
        //bool Recieved_message = doc["message"];
        //bool broadcastAddress1Status=Recieved_message;
        JsonArray RecAddress1 =doc["message"];
        //uint8_t Recieved_message[]={0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xAB};
        //Serial.print("Recieved message: ");        
        for (int i=0; i <6; ++i)
        {
          //Serial.print(doc["message"][i]);
          broadcastAddress1[i]=RecAddress1[i];
          //Serial.print(", ");
        }
        Serial.println(" ");
        /*
        ...
        for (int i=0; i <6; ++i)
        {
          broadcastAddress1[i]=Recieved_message[i];
        }*/      
        client->text(msg_buf);
        //webSocket.sendTXT(client, msg_buf);
        for (int i=0;i <6; ++i)
